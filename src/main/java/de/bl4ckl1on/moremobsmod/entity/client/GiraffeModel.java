...
public class GiraffeModel<T extends GiraffeEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = giraffe.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 15).addBox(-4.5F, -18.0F, -3.0F, 9.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, 11.0F, 0.8727F, 0.0F, 0.0F));

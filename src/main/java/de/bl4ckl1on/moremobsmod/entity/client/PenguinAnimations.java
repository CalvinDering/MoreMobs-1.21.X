...
public class PenguinAnimations {
    public static final AnimationDefinition ANIM_PENGUIN_IDLE = AnimationDefinition.Builder.withLength(0.0F).looping()

            .build();

    public static final AnimationDefinition ANIM_PENGUIN_SWIM = AnimationDefinition.Builder.withLength(0.0F).looping()
    ...
    public static final AnimationDefinition ANIM_PENGUIN_WALK = AnimationDefinition.Builder.withLength(0.5F).looping()
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.125F, KeyframeAnimations.degreeVec(10.0F, 0.0F, -15.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.375F, KeyframeAnimations.degreeVec(10.0F, 0.0F, 15.0F), AnimationChannel.Interpolations.LINEAR),
